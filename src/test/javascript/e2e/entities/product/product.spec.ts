...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productComponentsPage.getTitle()).to.eq('onlinestoreApp.product.home.title');
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('onlinestoreApp.product.home.createOrEditLabel');
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      ...
      productUpdatePage.setDescripcionInput('descripcion'),
    ...
    expect(await productUpdatePage.getDescripcionInput()).to.eq('descripcion', 'Expected Descripcion value to be equals to descripcion');
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('onlinestoreApp.product.delete.question');
