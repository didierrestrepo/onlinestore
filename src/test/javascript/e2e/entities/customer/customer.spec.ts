...
describe('Customer e2e test', () => {
  ...
  it('should load Customers', async () => {
    ...
    expect(await customerComponentsPage.getTitle()).to.eq('onlinestoreApp.customer.home.title');
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle()).to.eq('onlinestoreApp.customer.home.createOrEditLabel');
  ...
  it('should create and save Customers', async () => {
    ...
    await promise.all([
      ...
      customerUpdatePage.setAddresLine1Input('addresLine1'),
    ...
    expect(await customerUpdatePage.getAddresLine1Input()).to.eq('addresLine1', 'Expected AddresLine1 value to be equals to addresLine1');
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle()).to.eq('onlinestoreApp.customer.delete.question');
