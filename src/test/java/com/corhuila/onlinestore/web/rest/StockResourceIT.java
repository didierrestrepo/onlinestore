...
import com.corhuila.onlinestore.repository.StockRepository;
import com.corhuila.onlinestore.service.StockService;
import com.corhuila.onlinestore.service.dto.StockDTO;
import com.corhuila.onlinestore.service.mapper.StockMapper;
import com.corhuila.onlinestore.service.dto.StockCriteria;
import com.corhuila.onlinestore.service.StockQueryService;
...
public class StockResourceIT {
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.isEstado()).isEqualTo(DEFAULT_ESTADO);
    }
    ...
    @Test
    @Transactional
    public void getAllStocksByEstadoIsEqualToSomething() throws Exception {
        // Initialize the database
        stockRepository.saveAndFlush(stock);

        // Get all the stockList where estado equals to DEFAULT_ESTADO
        defaultStockShouldBeFound("estado.equals=" + DEFAULT_ESTADO);

        // Get all the stockList where estado equals to UPDATED_ESTADO
        defaultStockShouldNotBeFound("estado.equals=" + UPDATED_ESTADO);
    }

    @Test
    @Transactional
    public void getAllStocksByEstadoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        stockRepository.saveAndFlush(stock);

        // Get all the stockList where estado not equals to DEFAULT_ESTADO
        defaultStockShouldNotBeFound("estado.notEquals=" + DEFAULT_ESTADO);

        // Get all the stockList where estado not equals to UPDATED_ESTADO
        defaultStockShouldBeFound("estado.notEquals=" + UPDATED_ESTADO);
    }

    @Test
    @Transactional
    public void getAllStocksByEstadoIsInShouldWork() throws Exception {
        // Initialize the database
        stockRepository.saveAndFlush(stock);

        // Get all the stockList where estado in DEFAULT_ESTADO or UPDATED_ESTADO
        defaultStockShouldBeFound("estado.in=" + DEFAULT_ESTADO + "," + UPDATED_ESTADO);

        // Get all the stockList where estado equals to UPDATED_ESTADO
        defaultStockShouldNotBeFound("estado.in=" + UPDATED_ESTADO);
    }

    @Test
    @Transactional
    public void getAllStocksByEstadoIsNullOrNotNull() throws Exception {
        // Initialize the database
        stockRepository.saveAndFlush(stock);

        // Get all the stockList where estado is not null
        defaultStockShouldBeFound("estado.specified=true");

        // Get all the stockList where estado is null
        defaultStockShouldNotBeFound("estado.specified=false");
    }

    @Test
    @Transactional
    public void getAllStocksByProductIsEqualToSomething() throws Exception {
    ...
    public void updateStock() throws Exception {
        ...
        assertThat(testStock.isEstado()).isEqualTo(UPDATED_ESTADO);
    }
