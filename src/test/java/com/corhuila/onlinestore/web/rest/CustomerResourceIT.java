...
public class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "(q4@An~.]Q|9v";
    private static final String UPDATED_EMAIL = "gX[-@9.lwrwoz";

    private static final String DEFAULT_PHONE = "AAAAAAAAAA";
    private static final String UPDATED_PHONE = "BBBBBBBBBB";

    private static final String DEFAULT_ADDRES_LINE_1 = "AAAAAAAAAA";
    private static final String UPDATED_ADDRES_LINE_1 = "BBBBBBBBBB";
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .email(DEFAULT_EMAIL)
            .phone(DEFAULT_PHONE)
            .addresLine1(DEFAULT_ADDRES_LINE_1);
        return customer;
    }
    /**
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .email(UPDATED_EMAIL)
            .phone(UPDATED_PHONE)
            .addresLine1(UPDATED_ADDRES_LINE_1);
        return customer;
    }
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAddresLine1()).isEqualTo(DEFAULT_ADDRES_LINE_1);
    }
    ...
    @Test
    @Transactional
    public void checkAddresLine1IsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setAddresLine1(null);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].addresLine1").value(hasItem(DEFAULT_ADDRES_LINE_1)));
    }
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.addresLine1").value(DEFAULT_ADDRES_LINE_1));
    }
    ...
    @Test
    @Transactional
    public void getAllCustomersByAddresLine1IsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where addresLine1 equals to DEFAULT_ADDRES_LINE_1
        defaultCustomerShouldBeFound("addresLine1.equals=" + DEFAULT_ADDRES_LINE_1);

        // Get all the customerList where addresLine1 equals to UPDATED_ADDRES_LINE_1
        defaultCustomerShouldNotBeFound("addresLine1.equals=" + UPDATED_ADDRES_LINE_1);
    }

    @Test
    @Transactional
    public void getAllCustomersByAddresLine1IsNotEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where addresLine1 not equals to DEFAULT_ADDRES_LINE_1
        defaultCustomerShouldNotBeFound("addresLine1.notEquals=" + DEFAULT_ADDRES_LINE_1);

        // Get all the customerList where addresLine1 not equals to UPDATED_ADDRES_LINE_1
        defaultCustomerShouldBeFound("addresLine1.notEquals=" + UPDATED_ADDRES_LINE_1);
    }

    @Test
    @Transactional
    public void getAllCustomersByAddresLine1IsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where addresLine1 in DEFAULT_ADDRES_LINE_1 or UPDATED_ADDRES_LINE_1
        defaultCustomerShouldBeFound("addresLine1.in=" + DEFAULT_ADDRES_LINE_1 + "," + UPDATED_ADDRES_LINE_1);

        // Get all the customerList where addresLine1 equals to UPDATED_ADDRES_LINE_1
        defaultCustomerShouldNotBeFound("addresLine1.in=" + UPDATED_ADDRES_LINE_1);
    }

    @Test
    @Transactional
    public void getAllCustomersByAddresLine1IsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where addresLine1 is not null
        defaultCustomerShouldBeFound("addresLine1.specified=true");

        // Get all the customerList where addresLine1 is null
        defaultCustomerShouldNotBeFound("addresLine1.specified=false");
    }
                @Test
    @Transactional
    public void getAllCustomersByAddresLine1ContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where addresLine1 contains DEFAULT_ADDRES_LINE_1
        defaultCustomerShouldBeFound("addresLine1.contains=" + DEFAULT_ADDRES_LINE_1);

        // Get all the customerList where addresLine1 contains UPDATED_ADDRES_LINE_1
        defaultCustomerShouldNotBeFound("addresLine1.contains=" + UPDATED_ADDRES_LINE_1);
    }

    @Test
    @Transactional
    public void getAllCustomersByAddresLine1NotContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where addresLine1 does not contain DEFAULT_ADDRES_LINE_1
        defaultCustomerShouldNotBeFound("addresLine1.doesNotContain=" + DEFAULT_ADDRES_LINE_1);

        // Get all the customerList where addresLine1 does not contain UPDATED_ADDRES_LINE_1
        defaultCustomerShouldBeFound("addresLine1.doesNotContain=" + UPDATED_ADDRES_LINE_1);
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAddresLine1()).isEqualTo(UPDATED_ADDRES_LINE_1);
    }
