...
export class ProductCategoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.productCategoryService
      ...
      .subscribe(
        (res: HttpResponse<IProductCategory[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IProductCategory[] | null, headers: HttpHeaders, page: number): void {
